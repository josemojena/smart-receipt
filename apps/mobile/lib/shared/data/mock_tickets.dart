...
final List<Ticket> mockTickets = [
  Ticket(
    ...
    products: const [
      Product(name: 'Leche Entera (1L)', unitPrice: 1.25, quantity: 2.0),
      Product(
      ...
      Product(name: 'Manzanas Golden (kg)', unitPrice: 2.10, quantity: 1.0),
    ],
  ),
  Ticket(
    id: '2',
    ...
    products: const [
      Product(name: 'Paracetamol 500mg', unitPrice: 3.50, quantity: 1.0),
      Product(name: 'Vitamina C (30 tabs)', unitPrice: 9, quantity: 1.0),
    ],
  ),
];
